userprofile.grid.Items = function (config) {
	config = config || {};
	if (!config.id) {
		config.id = 'userprofile-grid-items';
	}
	Ext.applyIf(config, {
	...
	userprofile.grid.Items.superclass.constructor.call(this, config);
...
Ext.extend(userprofile.grid.Items, MODx.grid.Grid, {
	windows: {},
...
Ext.reg('userprofile-grid-items', userprofile.grid.Items);